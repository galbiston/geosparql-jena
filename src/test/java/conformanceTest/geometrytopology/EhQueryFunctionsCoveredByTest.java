...
public class EhQueryFunctionsCoveredByTest {
    ...
    public void positiveTest() {
        ...
        this.actualList = resourceQuery(geometryTopologyQuery("geof:ehCoveredBy", "Polygon((-83.6 34.1, -83.2 34.1, -83.2 34.5, -83.6 34.5, -83.6 34.1))"), INF_WKT_MODEL);
    ...
    public void negativeTest() {
        ...
        assertFalse("failure - should be false", emptyQuery(geometryTopologyQuery("geof:ehCoveredBy", "Point(-86.4 31.4)"), INF_WKT_MODEL));
    }
