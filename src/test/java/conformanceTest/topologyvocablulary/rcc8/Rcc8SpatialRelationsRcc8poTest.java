...
public class Rcc8SpatialRelationsRcc8poTest {
    ...
    public void positiveTest() {
        ...
        ArrayList<String> actualList = resourceQuery(topologyVocabluaryQuery("ex:F", "geo:rcc8po", ""), infModel);
    ...
    public void negativeTest() {
        ...
        assertFalse(emptyQuery(topologyVocabluaryQuery("ex:A", "geo:rcc8po", "FILTER ( ?aGeom != ?bGeom )"), infModel));
