...
public class Rcc8SpatialRelationsRcc8ntppTest {
    ...
    public void positiveTest() {
        ...
        ArrayList<String> actualList = resourceQuery(topologyVocabluaryQuery("ex:C", "geo:rcc8ntpp", ""), infModel);
    ...
    public void negativeTest() {
        ...
        assertFalse(emptyQuery(topologyVocabluaryQuery("ex:E", "geo:rcc8ntpp", "FILTER ( ?aGeom != ?bGeom )"), infModel));
