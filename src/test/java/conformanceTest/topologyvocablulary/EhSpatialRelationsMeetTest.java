...
public class EhSpatialRelationsMeetTest {
    ...
    public void positiveTest() {
        ...
        this.actualList = resourceQuery(topologyVocabluary("ex:C", "geo:ehMeet", ""), INF_WKT_MODEL);
    ...
    public void negativeTest() {
        ...
        assertFalse("failure - should be false", emptyQuery(topologyVocabluary("ex:A", "geo:ehMeet", "FILTER ( ?aGeom != ?bGeom )"), INF_WKT_MODEL));
    }
