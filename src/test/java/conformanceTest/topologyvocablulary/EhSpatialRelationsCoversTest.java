...
public class EhSpatialRelationsCoversTest {
    ...
    public void positiveTest() {
        ...
        ArrayList<String> actualList = resourceQuery(topologyVocabluaryQuery("ex:D", "geo:ehCovers", ""), infModel);
    ...
    public void negativeTest() {
        ...
        assertFalse(emptyQuery(topologyVocabluaryQuery("ex:E", "geo:ehCovers", "FILTER ( ?aGeom != ?bGeom )"), infModel));
