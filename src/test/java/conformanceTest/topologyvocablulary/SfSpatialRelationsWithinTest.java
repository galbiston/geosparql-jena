...
public class SfSpatialRelationsWithinTest {
    ...
    public void positiveTest() {
        ...
        ArrayList<String> actualList = resourceQuery(topologyVocabluaryQuery("ex:C", "geo:sfWithin", ""), infModel);
    ...
    public void negativeTest() {
        ...
        assertFalse(emptyQuery(topologyVocabluaryQuery("ex:A", "geo:sfWithin", "FILTER ( ?aGeom != ?bGeom )"), infModel));
