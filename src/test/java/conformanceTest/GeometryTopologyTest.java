 ...
 * /conf/geometry-topology-extension.
 */
public class GeometryTopologyTest {
    ...
    /**
     * A.4.1 Tests for all relation families A.4.1.1
     ...
     * consistent with the relate operator defined in Simple Features [ISO
     * 19125-1].
     *
     * a.) Test purpose: check conformance with this requirement
     *
     * b.) Test method: Verify that a set of SPARQL queries involving the
     * geof:relate function returns the correct result for a test dataset when
     * using the specified serialization and version.
     *
    ...
    /**
     * A.4.2 relation_family = Simple Features A.4.2.1
     ...
     * when using the specified serialization and version: geof:sfEquals,
     * geof:sfDisjoint, geof:sfIntersects, geof:sfTouches, geof:sfCrosses,
    ...
    /**
     * A.4.3 relation_family = Egenhofer A.4.3.1
     ...
     * with their corresponding DE-9IM intersection patterns, as defined by
     ...
     * b.) Test method: Verify that a set of SPARQL queries involving each of
     * the following functions returns the correct result for a test dataset
     * when using the specified serialization and version: geof:ehEquals,
     * geof:ehDisjoint, geof:ehMeet, geof:ehOverlap, geof:ehCovers,
    ...
    /**
     * A.4.4 relation_family = RCC8 A.4.4.1
     ...
     * geof:rcc8po, geof:rcc8tppi, geof:rcc8tpp, geof:rcc8ntpp, geof:rcc8ntppi
     ...
     * b.) Test method: Verify that a set of SPARQL queries involving each of
     * the following functions returns the correct result for a test dataset
     * when using the specified serialization and version: geof:rcc8eq,
     * geof:rcc8dc, geof:rcc8ec, geof:rcc8po, geof:rcc8tppi, geof:rcc8tpp,
