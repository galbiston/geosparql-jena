 ...
 */
public class Rcc8QueryRewriteRcc8tppTest {
    ...
    public void featureFeatureTest() {
        ...
        ArrayList<String> actualList = resourceQuery(featureFeatureQueryRewriteQuery("ex:C", "geo:rcc8tpp"), infModel);
    ...
    public void featureGeometryTest() {
        ...
        ArrayList<String> actualList = resourceQuery(featureGeometryQueryRewriteQuery("ex:C", "geo:rcc8tpp"), infModel);
        assertEquals(expectedList, actualList);
    ...
    public void geometryFeatureTest() {
        ...
        ArrayList<String> actualList = resourceQuery(geometryFeatureQueryRewriteQuery("ex:C", "geo:rcc8tpp"), infModel);
        assertEquals(expectedList, actualList);
