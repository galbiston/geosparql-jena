 ...
 */
public class Rcc8QueryRewriteRcc8ntppiTest {
    ...
    public void featureFeatureTest() {
        ...
        ArrayList<String> actualList = resourceQuery(featureFeatureQueryRewriteQuery("ex:G", "geo:rcc8ntppi"), infModel);
    ...
    public void featureGeometryTest() {
        ...
        ArrayList<String> actualList = resourceQuery(featureGeometryQueryRewriteQuery("ex:G", "geo:rcc8ntppi"), infModel);
        assertEquals(expectedList, actualList);
    ...
    public void geometryFeatureTest() {
        ...
        ArrayList<String> actualList = resourceQuery(geometryFeatureQueryRewriteQuery("ex:G", "geo:rcc8ntppi"), infModel);
        assertEquals(expectedList, actualList);
