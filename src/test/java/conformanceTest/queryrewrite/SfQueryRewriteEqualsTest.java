 ...
 */
public class SfQueryRewriteEqualsTest {
    ...
    public void featureFeatureTest() {
        ...
        ArrayList<String> actualList = resourceQuery(featureFeatureQueryRewriteQuery("ex:C", "geo:sfEquals"), infModel);
    ...
    public void featureGeometryTest() {
        ...
        ArrayList<String> actualList = resourceQuery(featureGeometryQueryRewriteQuery("ex:C", "geo:sfEquals"), infModel);
        assertEquals(expectedList, actualList);
    ...
    public void geometryFeatureTest() {
        ...
        ArrayList<String> actualList = resourceQuery(geometryFeatureQueryRewriteQuery("ex:C", "geo:sfEquals"), infModel);
        assertEquals(expectedList, actualList);
