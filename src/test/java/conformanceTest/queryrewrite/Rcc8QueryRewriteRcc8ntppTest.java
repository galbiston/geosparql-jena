...
public class Rcc8QueryRewriteRcc8ntppTest {
    ...
    public void featureFeatureTest() {
        ...
        this.actualList = resourceQuery(featureFeatureQueryRewriteQuery("ex:C", "geo:rcc8ntpp"), INF_WKT_MODEL);
    ...
    public void featureGeometryTest() {
        ...
        this.actualList = resourceQuery(featureGeometryQueryRewriteQuery("ex:C", "geo:rcc8ntpp"), INF_WKT_MODEL);
        assertEquals("failure - result arrays list not same", this.expectedList, this.actualList);
    ...
    public void geometryFeatureTest() {
        ...
        this.actualList = resourceQuery(geometryFeatureQueryRewriteQuery("ex:C", "geo:rcc8ntpp"), INF_WKT_MODEL);
        assertEquals("failure - result arrays list not same", this.expectedList, this.actualList);
