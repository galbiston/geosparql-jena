...
public class EhQueryRewriteInsideTest {
    ...
    public void featureFeatureTest() {
        ...
        this.actualList = resourceQuery(featureFeatureQueryRewriteQuery("ex:C", "geo:ehInside"), INF_WKT_MODEL);
    ...
    public void featureGeometryTest() {
        ...
        this.actualList = resourceQuery(featureGeometryQueryRewriteQuery("ex:C", "geo:ehInside"), INF_WKT_MODEL);
        assertEquals("failure - result arrays list not same", this.expectedList, this.actualList);
    ...
    public void geometryFeatureTest() {
        ...
        this.actualList = resourceQuery(geometryFeatureQueryRewriteQuery("ex:C", "geo:ehInside"), INF_WKT_MODEL);
        assertEquals("failure - result arrays list not same", this.expectedList, this.actualList);
