...
public class QueryFunctionsTest {
    ...
    public void bufferTest() {
        ...
        List<String> expectedList = Arrays.asList("http://example.org/ApplicationSchema#B", "http://example.org/ApplicationSchema#C");
    ...
    public void anotherBufferTest() {
        ...
        List<String> expectedList = Arrays.asList("http://example.org/ApplicationSchema#B", "http://example.org/ApplicationSchema#C", "http://example.org/ApplicationSchema#D", "http://example.org/ApplicationSchema#F");
    ...
    public void differenceTest() {
        ...
        List<String> expectedList = Arrays.asList("http://example.org/ApplicationSchema#E");
    ...
    public void distanceTest() {
        ...
        List<String> expectedList = Arrays.asList("http://example.org/ApplicationSchema#C", "http://example.org/ApplicationSchema#B", "http://example.org/ApplicationSchema#F");
