...
public class EastPFTest {
    ...
    public void testBuildSearchEnvelope() {
        ...
        SearchEnvelope expResult = SearchEnvelope.build(geometryWrapper, SpatialIndexTestData.WGS_84_CRS_INFO, CardinalDirection.EAST);
        SearchEnvelope result = instance.buildSearchEnvelope(geometryWrapper, SpatialIndexTestData.WGS_84_CRS_INFO);
    ...
    public void testCheckSearchEnvelope_no_wrap() {
        ...
        EastPF instance = new EastPF();
        SearchEnvelope searchEnvelope = instance.buildSearchEnvelope(geometryWrapper, SpatialIndexTestData.WGS_84_CRS_INFO); //Needed to initialise the search.
