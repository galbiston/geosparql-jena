...
public class DistanceFFTest {
    ...
    public void testExec_query() {
        ...
        List<Literal> expResults = Arrays.asList(ResourceFactory.createTypedLiteral("344.6516068987778e0", XSDDatatype.XSDdouble));
