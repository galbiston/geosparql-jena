...
public class Rcc8ntppTest {
    ...
    public void rcc8ntppBoundPostiveTest() {
        ...
        String result = FilterTestMethods.runBoundQuery("http://example.org/Geometry#PolygonL", "geof:rcc8ntpp", "http://example.org/Geometry#PolygonJ");
    ...
    public void rcc8ntppBoundNegativeTest() {
        ...
        String result = FilterTestMethods.runBoundQuery("http://example.org/Geometry#PolygonJ", "geof:rcc8ntpp", "http://example.org/Geometry#PolygonK");
    ...
    public void rcc8ntppUnboundPostiveTest() {
        ...
        List<String> result = FilterTestMethods.runUnboundQuery("http://example.org/Geometry#PolygonL", "geof:rcc8ntpp");
    ...
    public void rcc8ntppUnboundNegativeTest() {
        ...
        List<String> expResult = new ArrayList<>();
        List<String> result = FilterTestMethods.runUnboundQuery("http://example.org/Geometry#PolygonI", "geof:rcc8ntpp");
