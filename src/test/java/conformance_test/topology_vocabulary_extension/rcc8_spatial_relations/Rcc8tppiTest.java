...
public class Rcc8tppiTest {
    ...
    public void positiveTest() {
        ...
        ArrayList<String> actualList = resourceQuery(topologyVocabluaryQuery("ex:D", "geo:rcc8tppi", ""), infModel);
    ...
    public void negativeTest() {
        ...
        assertEquals(expectedList, resourceQuery(topologyVocabluaryQuery("ex:E", "geo:rcc8tppi", "FILTER ( ?aGeom != ?bGeom )"), infModel));
