...
public class Rcc8tppTest {
    ...
    public void positiveTest() {
        ...
        ArrayList<String> actualList = resourceQuery(topologyVocabluaryQuery("ex:C", "geo:rcc8tpp", ""), infModel);
    ...
    public void negativeTest() {
        ...
        assertEquals(expectedList, resourceQuery(topologyVocabluaryQuery("ex:E", "geo:rcc8tpp", "FILTER ( ?aGeom != ?bGeom )"), infModel));
