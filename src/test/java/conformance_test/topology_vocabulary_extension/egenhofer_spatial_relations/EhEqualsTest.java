...
public class EhEqualsTest {
    ...
    public void positiveTest() {
        ...
        ArrayList<String> result = resourceQuery(topologyVocabluaryQuery("ex:C", "geo:ehEquals", ""), infModel);
    ...
    public void negativeTest() {
        ...
        assertEquals(expResult, resourceQuery(topologyVocabluaryQuery("ex:A", "geo:ehEquals", "FILTER ( ?aGeom != ?bGeom )"), infModel));
