...
public class EhDisjointTest {
    ...
    public void positiveTest() {
        ...
        ArrayList<String> actualList = resourceQuery(topologyVocabluaryQuery("ex:A", "geo:ehDisjoint", ""), infModel);
    ...
    public void negativeTest() {
        ...
        assertEquals(expectedList, resourceQuery(topologyVocabluaryQuery("ex:C", "geo:ehDisjoint", "FILTER ( ?aGeom != ?bGeom )"), infModel));
    }
