...
public class Rcc8ecTest {
    ...
    public void featureFeatureTest() {
        ...
        ArrayList<String> actualList = resourceQuery(featureFeatureQuery("ex:C", "geo:rcc8ec"), infModel);
    ...
    public void featureGeometryTest() {
        ...
        ArrayList<String> actualList = resourceQuery(featureGeometryQuery("ex:C", "geo:rcc8ec"), infModel);
        assertEquals(expectedList, actualList);
    ...
    public void geometryFeatureTest() {
        ...
        ArrayList<String> actualList = resourceQuery(geometryFeatureQuery("ex:C", "geo:rcc8ec"), infModel);
        assertEquals(expectedList, actualList);
