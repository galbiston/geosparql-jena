...
public class Rcc8eqTest {
    ...
    public void featureFeatureTest() {
        ...
        ArrayList<String> result = resourceQuery(featureFeatureQuery("ex:C", "geo:rcc8eq"), infModel);
    ...
    public void featureGeometryTest() {
        ...
        ArrayList<String> result = resourceQuery(featureGeometryQuery("ex:C", "geo:rcc8eq"), infModel);
        assertEquals(expResult, result);
    ...
    public void geometryFeatureTest() {
        ...
        ArrayList<String> result = resourceQuery(geometryFeatureQuery("ex:C", "geo:rcc8eq"), infModel);
        assertEquals(expResult, result);
