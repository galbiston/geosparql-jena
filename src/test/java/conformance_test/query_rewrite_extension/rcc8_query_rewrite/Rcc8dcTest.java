...
public class Rcc8dcTest {
    ...
    public void featureFeatureTest() {
        ...
        ArrayList<String> actualList = resourceQuery(featureFeatureQuery("ex:C", "geo:rcc8dc"), infModel);
    ...
    public void featureGeometryTest() {
        ...
        ArrayList<String> expectedList = new ArrayList<>();
        ArrayList<String> actualList = resourceQuery(featureGeometryQuery("ex:C", "geo:rcc8dc"), infModel);
        assertEquals(expectedList, actualList);
    ...
    public void geometryFeatureTest() {
        ...
        ArrayList<String> expectedList = new ArrayList<>();
        ArrayList<String> actualList = resourceQuery(geometryFeatureQuery("ex:C", "geo:rcc8dc"), infModel);
        assertEquals(expectedList, actualList);
