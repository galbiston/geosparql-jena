...
public class Rcc8dcTest {
    ...
    public void featureFeatureTest() {
        ...
        ArrayList<String> result = resourceQuery(featureFeatureQuery("ex:C", "geo:rcc8dc"), infModel);
    ...
    public void featureGeometryTest() {
        ...
        ArrayList<String> expResult = new ArrayList<>();
        ArrayList<String> result = resourceQuery(featureGeometryQuery("ex:C", "geo:rcc8dc"), infModel);
        assertEquals(expResult, result);
    ...
    public void geometryFeatureTest() {
        ...
        ArrayList<String> expResult = new ArrayList<>();
        ArrayList<String> result = resourceQuery(geometryFeatureQuery("ex:C", "geo:rcc8dc"), infModel);
        assertEquals(expResult, result);
