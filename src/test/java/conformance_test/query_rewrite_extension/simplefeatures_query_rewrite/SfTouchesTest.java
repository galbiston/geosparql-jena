...
public class SfTouchesTest {
    ...
    public void featureFeatureTest() {
        ...
        ArrayList<String> actualList = resourceQuery(featureFeatureQuery("ex:C", "geo:sfTouches"), infModel);
    ...
    public void featureGeometryTest() {
        ...
        ArrayList<String> actualList = resourceQuery(featureGeometryQuery("ex:C", "geo:sfTouches"), infModel);
        assertEquals(expectedList, actualList);
    ...
    public void geometryFeatureTest() {
        ...
        ArrayList<String> actualList = resourceQuery(geometryFeatureQuery("ex:C", "geo:sfTouches"), infModel);
        assertEquals(expectedList, actualList);
