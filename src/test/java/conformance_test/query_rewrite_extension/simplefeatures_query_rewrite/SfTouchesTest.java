...
public class SfTouchesTest {
    ...
    public void featureFeatureTest() {
        ...
        ArrayList<String> result = resourceQuery(featureFeatureQuery("ex:C", "geo:sfTouches"), infModel);
    ...
    public void featureGeometryTest() {
        ...
        ArrayList<String> result = resourceQuery(featureGeometryQuery("ex:C", "geo:sfTouches"), infModel);
        assertEquals(expResult, result);
    ...
    public void geometryFeatureTest() {
        ...
        ArrayList<String> result = resourceQuery(geometryFeatureQuery("ex:C", "geo:sfTouches"), infModel);
        assertEquals(expResult, result);
