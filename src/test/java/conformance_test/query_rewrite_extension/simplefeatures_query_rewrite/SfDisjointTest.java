...
public class SfDisjointTest {
    ...
    public void featureFeatureTest() {
        ...
        ArrayList<String> actualList = resourceQuery(featureFeatureQuery("ex:C", "geo:sfDisjoint"), infModel);
    ...
    public void featureGeometryTest() {
        ...
        ArrayList<String> expectedList = new ArrayList<>();
        ArrayList<String> actualList = resourceQuery(featureGeometryQuery("ex:C", "geo:sfDisjoint"), infModel);
        assertEquals(expectedList, actualList);
    ...
    public void geometryFeatureTest() {
        ...
        ArrayList<String> expectedList = new ArrayList<>();
        ArrayList<String> actualList = resourceQuery(geometryFeatureQuery("ex:C", "geo:sfDisjoint"), infModel);
        assertEquals(expectedList, actualList);
