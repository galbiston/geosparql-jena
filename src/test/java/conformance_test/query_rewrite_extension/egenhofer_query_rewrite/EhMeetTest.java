...
public class EhMeetTest {
    ...
    public void featureFeatureTest() {
        ...
        List<String> result = queryMany(featureFeatureQuery("ex:C", "geo:ehMeet"), infModel);
    ...
    public void featureGeometryTest() {
        ...
        List<String> result = queryMany(featureGeometryQuery("ex:C", "geo:ehMeet"), infModel);
        assertEquals(expResult, result);
    ...
    public void geometryFeatureTest() {
        ...
        List<String> result = queryMany(geometryFeatureQuery("ex:C", "geo:ehMeet"), infModel);
        assertEquals(expResult, result);
