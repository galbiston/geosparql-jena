...
public class EhMeetTest {
    ...
    public void featureFeatureTest() {
        ...
        ArrayList<String> result = resourceQuery(featureFeatureQuery("ex:C", "geo:ehMeet"), infModel);
    ...
    public void featureGeometryTest() {
        ...
        ArrayList<String> result = resourceQuery(featureGeometryQuery("ex:C", "geo:ehMeet"), infModel);
        assertEquals(expResult, result);
    ...
    public void geometryFeatureTest() {
        ...
        ArrayList<String> result = resourceQuery(geometryFeatureQuery("ex:C", "geo:ehMeet"), infModel);
        assertEquals(expResult, result);
