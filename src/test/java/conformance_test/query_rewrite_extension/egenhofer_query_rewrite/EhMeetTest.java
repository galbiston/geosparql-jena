...
public class EhMeetTest {
    ...
    public void featureFeatureTest() {
        ...
        ArrayList<String> actualList = resourceQuery(featureFeatureQuery("ex:C", "geo:ehMeet"), infModel);
    ...
    public void featureGeometryTest() {
        ...
        ArrayList<String> actualList = resourceQuery(featureGeometryQuery("ex:C", "geo:ehMeet"), infModel);
        assertEquals(expectedList, actualList);
    ...
    public void geometryFeatureTest() {
        ...
        ArrayList<String> actualList = resourceQuery(geometryFeatureQuery("ex:C", "geo:ehMeet"), infModel);
        assertEquals(expectedList, actualList);
