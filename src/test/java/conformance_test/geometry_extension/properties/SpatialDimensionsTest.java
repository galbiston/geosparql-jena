...
public class SpatialDimensionsTest {
    ...
    @Test
    public void spatialDimensionBothBoundTest() {
        System.out.println("Spatial Dimension Both Bound");
    ...
    @Test
    public void spatialDimensionObjectUnboundTest() {
        System.out.println("Spatial Dimension Object Unbound");
    ...
    @Test
    public void spatialDimensionSubjectUnboundTest() {
        System.out.println("Spatial Dimension Subject Unbound");
    ...
    @Test
    public void spatialDimensionBothUnboundTest() {
        System.out.println("Spatial Dimension Both Unbound");
        ...
        String queryString = "SELECT ?feature ?spatialDimension WHERE{"
                + " ?feature geo:hasGeometry ?aGeom ."
                + " ?aGeom geo:spatialDimension ?spatialDimension ."
                + "}ORDER BY ?feature";
        List<String> result = TestQuerySupport.queryMany(queryString, SAMPLE_DATA_MODEL);
