 ...
 * @author haozhechen
 */
public class EqualsQRPropertyFuncTest {

    private static Model MODEL;
    private static InfModel INF_MODEL;
    private static final Logger LOGGER = LoggerFactory.getLogger(EqualsQRPropertyFuncTest.class);

    public EqualsQRPropertyFuncTest() {
    }
    ...
    /**
     * Test of exec method, of class SFEqualsQRPropertyFunc.
     */
    @Test
