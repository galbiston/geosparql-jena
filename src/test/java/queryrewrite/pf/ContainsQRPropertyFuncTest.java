 ...
 * @author haozhechen
 */
public class ContainsQRPropertyFuncTest {

    private static Model MODEL;
    private static InfModel INF_MODEL;
    private static final Logger LOGGER = LoggerFactory.getLogger(ContainsQRPropertyFuncTest.class);

    public ContainsQRPropertyFuncTest() {
    }
    ...
    /**
     * Test of exec method, of class SFContainsQRPropertyFunc.
     */
    @Test
