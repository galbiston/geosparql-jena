 ...
 * @author haozhechen
 */
public class CrossesQRPropertyFuncTest {

    private static Model MODEL;
    private static InfModel INF_MODEL;
    private static final Logger LOGGER = LoggerFactory.getLogger(CrossesQRPropertyFuncTest.class);

    public CrossesQRPropertyFuncTest() {
    }
    ...
    /**
     * Test of exec method, of class SFCrossesQRPropertyFunc.
     */
    @Test
