 ...
 * @author haozhechen
 */
public class TouchesQRPropertyFuncTest {

    private static Model MODEL;
    private static InfModel INF_MODEL;
    private static final Logger LOGGER = LoggerFactory.getLogger(TouchesQRPropertyFuncTest.class);

    public TouchesQRPropertyFuncTest() {
    }
    ...
    /**
     * Test of exec method, of class SFTouchesQRPropertyFunc.
     */
    @Test
