 ...
 * @author haozhechen
 */
public class RCC8EQFilterFunc extends FunctionBase2 {

    private static final Logger LOGGER = LoggerFactory.getLogger(RCC8EQFilterFunc.class);
