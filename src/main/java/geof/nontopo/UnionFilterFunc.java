 ...
 * @author haozhechen
 */
public class UnionFilterFunc extends FunctionBase2 {

    private static final Logger LOGGER = LoggerFactory.getLogger(UnionFilterFunc.class);
    ...
    public NodeValue exec(NodeValue v1, NodeValue v2) {
        ...
        try {
            ...
            return NodeValue.makeNodeString(generalDatatype.unparse(union));
