 ...
 */
public class TangentialProperPart extends GenericExpressionFunction {

    public TangentialProperPart(Expr expr1, Expr expr2) {
        super(expr1, expr2, Vocabulary.RCC_TANPROPERPART_SYMBOL);
    }

    @Override
    public Expr copy(Expr arg1, Expr arg2) {
        return new TangentialProperPart(arg1, arg2);
    }
