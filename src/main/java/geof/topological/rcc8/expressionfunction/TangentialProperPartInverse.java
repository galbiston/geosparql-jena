 ...
 */
public class TangentialProperPartInverse extends GenericExpressionFunction {

    public TangentialProperPartInverse(Expr expr1, Expr expr2) {
        super(expr1, expr2, Vocabulary.RCC_TANPROPERPARTINVERSE_SYMBOL);
    }

    @Override
    public Expr copy(Expr arg1, Expr arg2) {
        return new TangentialProperPartInverse(arg1, arg2);
    }
