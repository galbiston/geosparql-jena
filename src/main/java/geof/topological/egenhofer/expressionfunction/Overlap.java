 ...
 * @author haozhechen
 */
public class Overlap extends GenericExpressionFunction {

    public Overlap(Expr expr1, Expr expr2) {
        super(expr1, expr2, Vocabulary.EH_OVERLAP_SYMBOL);
    }

    @Override
    public Expr copy(Expr arg1, Expr arg2) {
        return new Overlap(arg1, arg2);
    }

    @Override
    protected boolean relate(GeometryWrapper sourceGeometry, GeometryWrapper targetGeometry) throws FactoryException, MismatchedDimensionException, TransformException {
        return sourceGeometry.relate(targetGeometry, "T*T***T**");
    }
