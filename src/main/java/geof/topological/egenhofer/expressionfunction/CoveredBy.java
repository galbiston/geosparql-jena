 ...
 * @author haozhechen
 */
public class CoveredBy extends GenericExpressionFunction {

    public CoveredBy(Expr expr1, Expr expr2) {
        super(expr1, expr2, Vocabulary.EH_CONTAINS_SYMBOL);
    }

    @Override
    public Expr copy(Expr arg1, Expr arg2) {
        return new CoveredBy(arg1, arg2);
    }

    @Override
    protected boolean relate(GeometryWrapper sourceGeometry, GeometryWrapper targetGeometry) throws FactoryException, MismatchedDimensionException, TransformException {
        return sourceGeometry.relate(targetGeometry, "TFF*TFT**");
    }
