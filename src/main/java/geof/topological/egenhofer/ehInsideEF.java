 ...
 */
public class ehInsideEF extends GenericExpressionFunction {

    public ehInsideEF(Expr expr1, Expr expr2) {
        super(expr1, expr2, Geof.EH_INSIDE);
    }

    @Override
    public Expr copy(Expr arg1, Expr arg2) {
        return new ehInsideEF(arg1, arg2);
    }
