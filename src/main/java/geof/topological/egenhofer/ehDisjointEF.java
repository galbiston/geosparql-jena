 ...
 */
package geof.topological.egenhofer;
 ...
 */
public class ehDisjointEF extends GenericExpressionFunction {

    public ehDisjointEF(Expr expr1, Expr expr2) {
        super(expr1, expr2, Geof.EH_DISJOINT);
    }

    @Override
    public Expr copy(Expr arg1, Expr arg2) {
        return new ehDisjointEF(arg1, arg2);
    }
