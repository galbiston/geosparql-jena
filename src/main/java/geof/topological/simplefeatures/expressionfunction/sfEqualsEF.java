 ...
 */
public class sfEqualsEF extends GenericExpressionFunction {

    public sfEqualsEF(Expr expr1, Expr expr2) {
        super(expr1, expr2, General.SF_EQUALS_SYMBOL);
    }

    @Override
    public Expr copy(Expr arg1, Expr arg2) {
        return new sfEqualsEF(arg1, arg2);
    }
