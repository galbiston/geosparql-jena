 ...
 */
public class sfIntersectsEF extends GenericExpressionFunction {

    public sfIntersectsEF(Expr expr1, Expr expr2) {
        super(expr1, expr2, General.SF_INTERSECTS_SYMBOL);
    }

    @Override
    public Expr copy(Expr arg1, Expr arg2) {
        return new sfIntersectsEF(arg1, arg2);
    }
