 ...
 */
public class sfDisjointEF extends GenericExpressionFunction {

    public sfDisjointEF(Expr expr1, Expr expr2) {
        super(expr1, expr2, General.SF_DISJOINT_SYMBOL);
    }

    @Override
    public Expr copy(Expr arg1, Expr arg2) {
        return new sfDisjointEF(arg1, arg2);
    }
