...
public class SFEqualsQRPropertyFunc extends PropertyFunctionBase {
    ...
    public QueryIterator exec(Binding binding, PropFuncArg argSubject, Node predicate, PropFuncArg argObject, ExecutionContext execCxt) {
        ...
        Triple NodeVarHasGML_SUB = new Triple(nodeVar_SUB, Vocabulary.WKT_PRO.asNode(), GMLVar_SUB);
        Triple NodeVarHasGML_OBJ = new Triple(nodeVar_OBJ, Vocabulary.WKT_PRO.asNode(), GMLVar_OBJ);
        ...
        Triple GeomHasGML_SUB = new Triple(GeomVar_SUB, Vocabulary.WKT_PRO.asNode(), GMLVar_SUB);
