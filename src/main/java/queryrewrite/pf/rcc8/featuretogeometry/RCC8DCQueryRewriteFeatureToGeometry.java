 ...
 */
package queryrewrite.pf.rcc8.featuretogeometry;
...
import queryrewrite.expr.rcc8.RCC8DCExprFunc;
 ...
 * @author haozhechen
 */
public class RCC8DCQueryRewriteFeatureToGeometry extends PropertyFunctionBase {
    ...
    public QueryIterator exec(Binding binding, PropFuncArg argSubject, Node predicate, PropFuncArg argObject, ExecutionContext execCxt) {
        ...
        Expr expr = new RCC8DCExprFunc(new ExprVar(SerializationVar_SUB.getName()), new ExprVar(SerializationVar_OBJ.getName()));
