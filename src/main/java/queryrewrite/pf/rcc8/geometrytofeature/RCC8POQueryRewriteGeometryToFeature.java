 ...
 */
package queryrewrite.pf.rcc8.geometrytofeature;
...
import queryrewrite.expr.rcc8.RCC8POExprFunc;
 ...
 * @author haozhechen
 */
public class RCC8POQueryRewriteGeometryToFeature extends PropertyFunctionBase {
    ...
    public QueryIterator exec(Binding binding, PropFuncArg argSubject, Node predicate, PropFuncArg argObject, ExecutionContext execCxt) {
        ...
        Expr expr = new RCC8POExprFunc(new ExprVar(SerializationVar_SUB.getName()), new ExprVar(SerializationVar_OBJ.getName()));
