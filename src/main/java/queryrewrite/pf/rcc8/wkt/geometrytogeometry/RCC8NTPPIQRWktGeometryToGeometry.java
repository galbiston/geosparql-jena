 ...
 */
package queryrewrite.pf.rcc8.wkt.geometrytogeometry;
...
import geof.topological.rcc8.expressionfunction.NonTangentialProperPartInverse;
 ...
 * @author haozhechen
 */
public class RCC8NTPPIQRWktGeometryToGeometry extends PropertyFunctionBase {
    ...
    public QueryIterator exec(Binding binding, PropFuncArg argSubject, Node predicate, PropFuncArg argObject, ExecutionContext execCxt) {
        ...
        Expr expr = new NonTangentialProperPartInverse(new ExprVar(WKTVar_SUB.getName()), new ExprVar(WKTVar_OBJ.getName()));
