 ...
 */
package queryrewrite.pf.rcc8.gml.geometrytogeometry;
 ...
 * @author haozhechen
 */
public class RCC8NTPPIQRGmlGeometryToGeometry extends PropertyFunctionBase {
    ...
    public QueryIterator exec(Binding binding, PropFuncArg argSubject, Node predicate, PropFuncArg argObject, ExecutionContext execCxt) {
        ...
        Expr expr = new NonTangentialProperPartInverse(new ExprVar(GMLVar_SUB.getName()), new ExprVar(GMLVar_OBJ.getName()));
