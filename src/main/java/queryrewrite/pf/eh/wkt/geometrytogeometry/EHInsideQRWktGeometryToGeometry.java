 ...
 */
package queryrewrite.pf.eh.wkt.geometrytogeometry;
...
import geof.topological.egenhofer.expressionfunction.ehInsideEF;
 ...
 * @author haozhechen
 */
public class EHInsideQRWktGeometryToGeometry extends PropertyFunctionBase {
    ...
    public QueryIterator exec(Binding binding, PropFuncArg argSubject, Node predicate, PropFuncArg argObject, ExecutionContext execCxt) {
        ...
        Expr expr = new ehInsideEF(new ExprVar(WKTVar_SUB.getName()), new ExprVar(WKTVar_OBJ.getName()));
