 ...
 */
package queryrewrite.pf.eh.gml.featuretogeometry;
 ...
 * @author haozhechen
 */
public class EHInsideQRGmlFeatureToGeometry extends PropertyFunctionBase {
    ...
    public QueryIterator exec(Binding binding, PropFuncArg argSubject, Node predicate, PropFuncArg argObject, ExecutionContext execCxt) {
        ...
        Expr expr = new ehInsideEF(new ExprVar(GMLVar_SUB.getName()), new ExprVar(GMLVar_OBJ.getName()));
