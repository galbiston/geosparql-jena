 ...
 */
package queryrewrite.pf.sf.gml.geometrytogeometry;
 ...
 * @author haozhechen
 */
public class SFIntersectsQRGmlGeometryToGeometry extends PropertyFunctionBase {
    ...
    public QueryIterator exec(Binding binding, PropFuncArg argSubject, Node predicate, PropFuncArg argObject, ExecutionContext execCxt) {
        ...
        Expr expr = new SFIntersectsExprFunc(new ExprVar(GMLVar_SUB.getName()), new ExprVar(GMLVar_OBJ.getName()));
