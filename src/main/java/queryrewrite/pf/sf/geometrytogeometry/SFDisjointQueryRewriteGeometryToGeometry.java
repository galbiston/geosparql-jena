...
import queryrewrite.expr.sf.SFDisjointExprFunc;
 ...
 * @author haozhechen
 */
public class SFDisjointQueryRewriteGeometryToGeometry extends PropertyFunctionBase {
    ...
    public QueryIterator exec(Binding binding, PropFuncArg argSubject, Node predicate, PropFuncArg argObject, ExecutionContext execCxt) {
        ...
        Expr expr = new SFDisjointExprFunc(new ExprVar(SerializationVar_SUB.getName()), new ExprVar(SerializationVar_OBJ.getName()));
