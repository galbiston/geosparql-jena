 ...
 */
package queryrewrite.pf.sf.geometrytogeometry;
...
import queryrewrite.expr.sf.SFIntersectsExprFunc;
 ...
 * @author haozhechen
 */
public class SFIntersectsQueryRewriteGeometryToGeometry extends PropertyFunctionBase {
    ...
    public QueryIterator exec(Binding binding, PropFuncArg argSubject, Node predicate, PropFuncArg argObject, ExecutionContext execCxt) {
        ...
        Expr expr = new SFIntersectsExprFunc(new ExprVar(SerializationVar_SUB.getName()), new ExprVar(SerializationVar_OBJ.getName()));
