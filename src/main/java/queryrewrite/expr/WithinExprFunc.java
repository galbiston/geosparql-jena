 ...
 * @author haozhechen
 */
public class WithinExprFunc extends ExprFunction2 {

    private static final Logger LOGGER = LoggerFactory.getLogger(WithinExprFunc.class);

    public WithinExprFunc(Expr expr1, Expr expr2) {
        super(expr1, expr2, Vocabulary.WITHIN_SYMBOL);
    }
    ...
    public Expr copy(Expr arg1, Expr arg2) {
        return new WithinExprFunc(arg1, arg2);
    }
