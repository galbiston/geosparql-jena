 ...
 * @author haozhechen
 */
public class OverlapsExprFunc extends ExprFunction2 {

    private static final Logger LOGGER = LoggerFactory.getLogger(OverlapsExprFunc.class);

    public OverlapsExprFunc(Expr expr1, Expr expr2) {
        super(expr1, expr2, Vocabulary.OVERLAPS_SYMBOL);
    }
    ...
    public Expr copy(Expr arg1, Expr arg2) {
        return new OverlapsExprFunc(arg1, arg2);
    }
