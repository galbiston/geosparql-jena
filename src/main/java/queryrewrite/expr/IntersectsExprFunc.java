 ...
 * @author haozhechen
 */
public class IntersectsExprFunc extends ExprFunction2 {

    private static final Logger LOGGER = LoggerFactory.getLogger(IntersectsExprFunc.class);

    public IntersectsExprFunc(Expr expr1, Expr expr2) {
        super(expr1, expr2, Vocabulary.INTERSECTS_SYMBOL);
    }
    ...
    public Expr copy(Expr arg1, Expr arg2) {
        return new IntersectsExprFunc(arg1, arg2);
    }
