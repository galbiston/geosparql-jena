 ...
 * @author haozhechen
 */
public class EHCoversExprFunc extends ExprFunction2 {

    private static final Logger LOGGER = LoggerFactory.getLogger(EHCoversExprFunc.class);

    public EHCoversExprFunc(Expr expr1, Expr expr2) {
    ...
    public NodeValue eval(NodeValue x, NodeValue y) {
        ...
        try {
            ...
            boolean result = g1.relate(g2, "T*TFT*FF*");
    ...
    public Expr copy(Expr arg1, Expr arg2) {
        return new EHCoversExprFunc(arg1, arg2);
    }
