 ...
 * @author haozhechen
 */
public class EHDisjointExprFunc extends ExprFunction2 {

    private static final Logger LOGGER = LoggerFactory.getLogger(EHDisjointExprFunc.class);

    public EHDisjointExprFunc(Expr expr1, Expr expr2) {
    ...
    public Expr copy(Expr arg1, Expr arg2) {
        return new EHDisjointExprFunc(arg1, arg2);
    }
