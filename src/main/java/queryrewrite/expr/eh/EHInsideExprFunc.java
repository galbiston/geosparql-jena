 ...
 * @author haozhechen
 */
public class EHInsideExprFunc extends ExprFunction2 {

    private static final Logger LOGGER = LoggerFactory.getLogger(EHInsideExprFunc.class);

    public EHInsideExprFunc(Expr expr1, Expr expr2) {
    ...
    public Expr copy(Expr arg1, Expr arg2) {
        return new EHInsideExprFunc(arg1, arg2);
    }
