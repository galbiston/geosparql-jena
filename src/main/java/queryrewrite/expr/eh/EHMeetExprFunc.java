 ...
 * @author haozhechen
 */
public class EHMeetExprFunc extends ExprFunction2 {

    private static final Logger LOGGER = LoggerFactory.getLogger(EHMeetExprFunc.class);

    public EHMeetExprFunc(Expr expr1, Expr expr2) {
    ...
    public NodeValue eval(NodeValue x, NodeValue y) {
        ...
        try {
            ...
            boolean result = g1.relate(g2, "FT*******") || g1.relate(g2, "F**T*****") || g1.relate(g2, "F***T****");
    ...
    public Expr copy(Expr arg1, Expr arg2) {
        return new EHMeetExprFunc(arg1, arg2);
    }
