 ...
 * @author haozhechen
 */
public class DisjointExprFunc extends ExprFunction2 {

    private static final Logger LOGGER = LoggerFactory.getLogger(EqualsExprFunc.class);

    public DisjointExprFunc(Expr expr1, Expr expr2) {
        super(expr1, expr2, Vocabulary.DISJOINT_SYMBOL);
    }
    ...
    public Expr copy(Expr arg1, Expr arg2) {
        return new DisjointExprFunc(arg1, arg2);
    }
