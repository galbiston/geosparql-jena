 ...
 * @author haozhechen
 */
public class CrossesExprFunc extends ExprFunction2 {

    private static final Logger LOGGER = LoggerFactory.getLogger(CrossesExprFunc.class);

    public CrossesExprFunc(Expr expr1, Expr expr2) {
        super(expr1, expr2, Vocabulary.CROSSES_SYMBOL);
    }
    ...
    public Expr copy(Expr arg1, Expr arg2) {
        return new CrossesExprFunc(arg1, arg2);
    }
