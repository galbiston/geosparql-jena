 ...
 * @author haozhechen
 */
public class RCC8NTPPExprFunc extends ExprFunction2 {

    private static final Logger LOGGER = LoggerFactory.getLogger(RCC8NTPPExprFunc.class);

    public RCC8NTPPExprFunc(Expr expr1, Expr expr2) {
    ...
    public NodeValue eval(NodeValue x, NodeValue y) {
        ...
        try {
            ...
            boolean result = g1.relate(g2, "TFFTFFTTT");
    ...
    public Expr copy(Expr arg1, Expr arg2) {
        return new RCC8NTPPExprFunc(arg1, arg2);
    }
