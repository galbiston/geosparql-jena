 ...
 * @author haozhechen
 */
public class RCC8TPPExprFunc extends ExprFunction2 {

    private static final Logger LOGGER = LoggerFactory.getLogger(RCC8TPPExprFunc.class);

    public RCC8TPPExprFunc(Expr expr1, Expr expr2) {
    ...
    public NodeValue eval(NodeValue x, NodeValue y) {
        ...
        try {
            ...
            boolean result = g1.relate(g2, "TFFTTFTTT");
    ...
    public Expr copy(Expr arg1, Expr arg2) {
        return new RCC8TPPExprFunc(arg1, arg2);
    }
