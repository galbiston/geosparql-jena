 ...
 * @author haozhechen
 */
public class RCC8POExprFunc extends ExprFunction2 {

    private static final Logger LOGGER = LoggerFactory.getLogger(RCC8POExprFunc.class);

    public RCC8POExprFunc(Expr expr1, Expr expr2) {
        super(expr1, expr2, Vocabulary.RCC_PARTOVERLAP_SYMBOL);
    }
    ...
    public NodeValue eval(NodeValue x, NodeValue y) {
        ...
        try {
            ...
            boolean result = g1.relate(g2, "TTTTTTTTT");
    ...
    public Expr copy(Expr arg1, Expr arg2) {
        return new RCC8POExprFunc(arg1, arg2);
    }
