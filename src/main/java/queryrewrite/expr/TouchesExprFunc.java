 ...
 * @author haozhechen
 */
public class TouchesExprFunc extends ExprFunction2 {

    private static final Logger LOGGER = LoggerFactory.getLogger(TouchesExprFunc.class);

    public TouchesExprFunc(Expr expr1, Expr expr2) {
    ...
    public Expr copy(Expr arg1, Expr arg2) {
        return new TouchesExprFunc(arg1, arg2);
    }
