 ...
 * @author haozhechen
 */
public class SFContainsExprFunc extends ExprFunction2 {

    private static final Logger LOGGER = LoggerFactory.getLogger(SFContainsExprFunc.class);

    public SFContainsExprFunc(Expr expr1, Expr expr2) {
    ...
    public Expr copy(Expr arg1, Expr arg2) {
        return new SFContainsExprFunc(arg1, arg2);
    }
