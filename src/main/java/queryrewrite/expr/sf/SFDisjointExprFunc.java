 ...
 * @author haozhechen
 */
public class SFDisjointExprFunc extends ExprFunction2 {

    private static final Logger LOGGER = LoggerFactory.getLogger(SFEqualsExprFunc.class);

    public SFDisjointExprFunc(Expr expr1, Expr expr2) {
    ...
    public Expr copy(Expr arg1, Expr arg2) {
        return new SFDisjointExprFunc(arg1, arg2);
    }
